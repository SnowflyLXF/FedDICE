...
flags.DEFINE_float('alpha', 0.,
                   'How close to target policy.')
flags.DEFINE_bool('tabular_obs', False,
                  'Whether to use tabular observations.')
flags.DEFINE_string('save_dir', '/home/snowfly/dice/dice_rl/tests/testdata', 'Directory to save dataset to.')
flags.DEFINE_string('load_dir', '/home/snowfly/dice/dice_rl/tests/testdata', 'Directory to load policies from.')
